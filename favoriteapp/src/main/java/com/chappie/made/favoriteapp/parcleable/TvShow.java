package com.chappie.made.favoriteapp.parcleable;

import android.database.Cursor;
import android.os.Parcel;
import android.os.Parcelable;

import com.chappie.made.favoriteapp.database.DatabaseContract;

import static com.chappie.made.favoriteapp.database.DatabaseContract.getColumnString;

public class TvShow implements Parcelable {
    private String id_tvshow, title, popularity, overview,img_poster,img_backdrop;

    public TvShow(String id_tvshow, String title, String popularity, String overview, String img_poster, String img_backdrop) {
    ...
    public TvShow(Cursor cursor){
        this.id_tvshow = getColumnString(cursor, DatabaseContract.TableColumns._ID);
